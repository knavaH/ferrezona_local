...
.carousel-item.item1 {
    background: url(../../../../images/herramientas_1.png) no-repeat center;
...
.carousel-item.item2 {
    background: url(../../../../images/herramientas_2.jpg) no-repeat center;
    background-size: cover;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
...
.carousel-item.item3 {
    background: url(../../../../images/marcas_1.png) no-repeat center;
    background-size: cover;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
...
.carousel-item.item4 {
    background: url(../../../../images/marcas_2.png) no-repeat center;
    background-size: cover;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
